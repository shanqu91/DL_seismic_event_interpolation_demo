...
# load trained model
model = load_model('../Data/trained_model_smallset.h5')

# prediction
Y_test = model.predict(X_test, batch_size=batch_size, verbose=1)
io.savemat('../Data/predicted_test_data_smallset.mat', {'Y_test':Y_test})
...
plt.title('with 1000 data including steep events, test data (left->input, right->predicted)')
