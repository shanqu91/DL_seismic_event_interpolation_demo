...
mat_contents = io.loadmat('../Data/X_train_full.mat')
X_train = mat_contents['X_train']
mat_contents = io.loadmat('../Data/Y_train_full.mat')
Y_train = mat_contents['Y_train']
mat_contents = io.loadmat('../Data/X_dev_full.mat')
X_dev = mat_contents['X_dev']
mat_contents = io.loadmat('../Data/Y_dev_full.mat')
...
model.save('../Data/trained_model_full.h5')
