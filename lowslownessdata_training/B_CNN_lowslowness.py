...
mat_contents = io.loadmat('../Data/X_train_lowslowness.mat')
X_train = mat_contents['X_train']
mat_contents = io.loadmat('../Data/Y_train_lowslowness.mat')
Y_train = mat_contents['Y_train']
mat_contents = io.loadmat('../Data/X_dev_lowslowness.mat')
X_dev = mat_contents['X_dev']
mat_contents = io.loadmat('../Data/Y_dev_lowslowness.mat')
...
####### non-linear mapping
# conv3 = Dense(20, activation='relu')(conv2)
# conv3 = Dropout(0.25)(conv3)
# conv3 = Dense(20, activation='relu')(conv3)
# conv3 = Dropout(0.25)(conv3)
# conv3 = Dense(20, activation='relu')(conv3)
# conv3 = Dropout(0.25)(conv3)
# conv3 = Dense(20, activation='relu')(conv3)
...
model.save('../Data/trained_model_lowslowness.h5')
